package com.jhonjson.lib_base.commonality.lifecycle
...
import com.jhonjson.lib_base.commonality.constant.BaseConstants
import com.jhonjson.lib_base.commonality.manager.ActivityStackManager
...
class ActivityLifecycleCallbacksImpl : Application.ActivityLifecycleCallbacks {
    ...
    override fun onActivityStopped(activity: Activity) {
        ...
        if(mCount <= 0 && !BaseConstants.isBackground && isRun(activity)){
            ...
            Toast.makeText(activity, "心符短视频进入后台", Toast.LENGTH_LONG).show()
        }
    }
